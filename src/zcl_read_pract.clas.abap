...
*        FROM VALUE #( ( %key-TravelId   = '00004136'
...
*        ALL FIELDS
*         WITH VALUE #( ( %key-TravelId   = '00004136' ) ( %key-TravelId   = '00004130') )
*         RESULT DATA(lt_result_short)
*         FAILED DATA(lt_failed_short).
*
*
...
*        ALL FIELDS WITH VALUE #( ( %key-TravelId   = '00004136' ) ( %key-TravelId   = '00004130' ) )
*                RESULT DATA(lt_result_short)
*
*        ENTITY zi_booking_kdas_m
**        ALL FIELDS WITH VALUE #( ( %key-TravelId   = '00004136'  %key-BookingId   = '0001' ) ( %key-TravelId   = '00004136'  %key-BookingId   = '0002' ) )
**        %key-BookingId   = '6969'
* ALL FIELDS WITH VALUE #( ( %key-TravelId   = '00004136'  %key-BookingId   = '0001' ) )
...
*    ENDIF.
    ...
    it_booking = VALUE #( ( %key-TravelId = '00004136'
                            %control = VALUE #(
    ...
    it_optab = VALUE #( ( op = if_abap_behv=>op-r-read
                  entity_name = 'ZI_TRAVEL_KDAS_M'     " Ctrl + shift + X to convert upper case"
