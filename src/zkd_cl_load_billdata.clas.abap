CLASS zkd_cl_load_billdata DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zkd_cl_load_billdata IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA lt_bill_header TYPE STANDARD TABLE OF zkd_bill_header.

    DELETE FROM zkd_bill_header.
    ...
    INSERT zkd_bill_header FROM TABLE @lt_bill_header.
